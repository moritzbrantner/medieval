...
#[must_use]
pub(crate) fn terrain_height_mm(
...
pub(crate) fn terrain_cell_bounds_mm(
    ...
    TacticalTerrain::battlefield_foundation().cell_bounds_mm(battlefield, cell_x, cell_z)
}
...
pub(crate) fn terrain_cell_world_bounds(
    ...
    Some((
        ...
        [
            x1 as f32,
            terrain_cell_height_mm(terrain, battlefield, cell_x, cell_z) as f32,
            z1 as f32,
        ],
    ))
}
...
mod tests {
    ...
    fn renderer_adapter_matches_the_core_terrain_contract() {
        ...
        let core = TacticalTerrain::battlefield_foundation();
        assert_eq!(
            terrain_height_mm(core, battlefield, point),
        ...
        assert_eq!(
            terrain_cell_height_mm(core, battlefield, 1, 4),
